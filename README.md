...
#### Фронтенд
* [**webpack-typescript-boilerplate**](https://github.com/Super-Cereal/webpack-typescript-boilerplate) универсальная легкомодифицируемая инфраструктура, с которой можно начать писать любое веб-приложение, будь то фронтенд, бекэнд или просто библиотека (webpack, typescript, eslint, prettier, husky, lint-staged)
