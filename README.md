...
### Обо мне
Привет, я - Егор, фронтенд-разработчик.  
...
#### Фронтенд
* [webpack-typescript-boilerplate](https://github.com/Super-Cereal/webpack-typscript-boilerplate) универсальная легкомодифицируемая архитектура, с которой можно начать писать любое веб-приложение (webpack, typescript, eslint, prettier, husky, lint-staged)
